...
model1_path = '.\\Continued_Model\\cp_15_1_tanh_kern_3_opt_adam_drop_0.ckpt.keras'
model1 = tf.keras.models.load_model(model1_path)
model2_path = '.\\CNN_Multi_Hyper\\cp_15_1_leaky_relu_kern_3_opt_adam_drop_0.ckpt.keras'
